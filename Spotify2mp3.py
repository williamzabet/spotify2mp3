...
def spotify2mp3(spotify_playlist_link, spotify_client_id, spotify_client_secret, youtube_key, 
...
spotify2mp3(spotify_playlist_link, spotify_client_id, spotify_client_secret, youtube_key, 
                chromeDriver_path, playlist_path)
